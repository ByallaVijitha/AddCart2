...
import com.example.addcart2.R
import com.example.addcart2.ResMenuActivity
...
class RestaurantsAdapter(private val context:Context,private val tempItemList:MutableList<RestaurantDataClass>): RecyclerView.Adapter<RestaurantsAdapter.RestaurantsViewHolder>() {
    ...
    class  RestaurantsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val ivResPic: ImageView=itemView.findViewById(R.id.ivResPic)
        val tvResName:TextView=itemView.findViewById(R.id.tvResName)
        val tvResCost:TextView=itemView.findViewById(R.id.tvResCost)
