...
import com.example.addcart2.datares.OrderDetails
import com.example.addcart2.datares.OrderHistoryParentAdapter
        ...
        val jsonObjectRequest = object : JsonObjectRequest(
            ...
            Response.Listener {
                ...
                if (data.getBoolean("success")) {
                    ...
                    if (resultJSONArray.length() == 0) {
                        ...
                        rvPreviousOrders.adapter =
                            OrderHistoryParentAdapter(activity as Context, ordersListFromAPI)
            ...
            Response.ErrorListener {
                ...
                Toast.makeText(activity as Context,
                    "Error receiving Data to the server!",
