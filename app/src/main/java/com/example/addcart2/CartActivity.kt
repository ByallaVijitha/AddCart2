...
import com.example.addcart2.datares.FoodItemDetails
import com.example.addcart2.datares.OrderHistoryChildAdapter
import com.example.addcart2.datares.RetrieveCartItemsAsyncTask
import com.example.addcart2.datares.RetrieveTotalOrCountAsyncTask
...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in tempCartItemsList.indices) {
            cartItemsList.add(FoodItemDetails(tempCartItemsList[i].id,
                tempCartItemsList[i].name,
                tempCartItemsList[i].cost.toString()))
